CREATE TABLE [dbo].[STG_ToyGraderItems] (
    ...
    CONSTRAINT [FK_STG_ToyGraderItem_STG_EBayItem] FOREIGN KEY ([ToyGraderBatchImporttId]) REFERENCES [dbo].[STG_EBayItems] ([EBayItemtId]),
    CONSTRAINT [FK_STG_ToyGraderItem_STG_ToyGraderBatchImport] FOREIGN KEY ([ToyGraderBatchImporttId]) REFERENCES [dbo].[STG_ToyGraderBatchImports] ([ToyGraderBatchImporttId])
);
