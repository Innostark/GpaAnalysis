...
using GPAA.Models.IdentityModels.ViewModels;
using GPAA.Web.ModelMappers;
...
using GPAA.Web.ViewModels.Common;
using System.Net;
...
namespace IdentitySample.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Create(RegisterViewModel model)
        {
            if (!string.IsNullOrEmpty(model.UserId))
            {
                ...
                if (userrRoleID != model.SelectedRole)
                {
                    ...
                    TempData["message"] = new MessageViewModel { Message = GPAA.Web.Resources.HR.Account.UpdateUser, IsUpdated = true };
                }
                // Password Reset
                if (!String.IsNullOrEmpty(model.Password))
                {
                    ...
                    if (resetPwdResults.Succeeded)
                    {
                        ...
                        {
                            Message = GPAA.Web.Resources.HR.Account.UpdatePass,
                            IsUpdated = true
                        };
                    }
                }
                ...
                if (userToUpdate.Email != model.Email)
                {
                    ...
                    if (updateUserResult.Succeeded)
                    {
                        TempData["message"] = new MessageViewModel
                        {
                            Message = GPAA.Web.Resources.HR.Account.UpdateUser,
                            IsUpdated = true
                        };
                    }
                }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (!String.IsNullOrEmpty(model.Password))
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        TempData["message"] = new MessageViewModel { Message = GPAA.Web.Resources.HR.Account.AddUser, IsSaved = true };
                        return RedirectToAction("Users");
                    }
                }
            }
            ...
            TempData["message"] = new MessageViewModel { Message = GPAA.Web.Resources.HR.Account.ChkFields, IsError = true };
            return View(model);
        }
        ...
        public async Task<ActionResult> Subscribe(SignupViewModel signupViewModel)
        {
            // Add new User
                ...
                if (usernames.Contains(signupViewModel.UserName))
                {
                    ...
                    TempData["message"] = new MessageViewModel { Message = GPAA.Web.Resources.HR.Account.EmpError, IsError = true };
                    return View(signupViewModel);
                }
        ...
        private async Task SaveAccessToken(GPAA.Models.DomainModels.AspNetUser user, ClaimsIdentity identity)
        {
